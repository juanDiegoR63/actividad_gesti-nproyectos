...
export const actionCatalog: DecisionOption[] = [
  {
    ...
    requirements: { time: 1 },
    baseEffects: {
      project: { time: -1, risk: -3, progress: 6 },
      targetEnemy: { hp: -12, threat: -2 },
      actor: { stress: 2 },
    },
    debtEffects: {
      project: { risk: 6, quality: -4 },
      actor: { stress: 8 },
    },
  ...
  },
  {
    ...
    baseEffects: {
      project: { budget: -2, time: -2, risk: -2, quality: 2, progress: 5 },
      targetEnemy: { hp: -14, threat: -3 },
      actor: { stress: 5 },
    },
    debtEffects: {
      project: { risk: 8, quality: -3 },
      actor: { stress: 10 },
    },
    roleScaling: { director: 1.15, planning: 1, quality: 1 },
    luckProfile: "high",
  ...
  },
  {
    ...
    baseEffects: {
      project: { budget: -1, quality: -1, risk: 4, progress: 8 },
  ...
  },
  {
    ...
    requirements: { time: 1 },
    baseEffects: {
      project: { time: -1, budget: -2, risk: -4, progress: 4 },
  ...
  },
  {
    ...
    baseEffects: {
      project: { budget: -6, risk: -8, quality: 2, progress: 3 },
  ...
  },
  {
    ...
    baseEffects: {
      project: { time: 2, quality: -3, risk: 3, progress: -2 },
      targetEnemy: { hp: -6, threat: -1 },
      actor: { stress: -2 },
    },
    debtEffects: {
      project: { risk: 8 },
  ...
  },
  {
    ...
    baseEffects: {
      project: { time: -1, budget: -2, quality: 8, risk: -5, progress: 2 },
      targetEnemy: { hp: -11, threat: -2 },
      actor: { stress: 4 },
    },
    debtEffects: {
      project: { risk: 7, progress: -3 },
    },
  ...
  },
  {
    ...
    baseEffects: {
      project: { time: -2, quality: 6, risk: -6, progress: -1 },
      targetEnemy: { hp: -13, threat: -2 },
      actor: { stress: 5 },
    },
    debtEffects: {
      project: { risk: 8, quality: -4 },
    },
  ...
  },
  {
    ...
    requirements: { time: 1 },
    baseEffects: {
      project: { time: -1, quality: 3, risk: -3, progress: 1 },
